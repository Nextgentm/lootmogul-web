      ...
      >
        ...
        >
          ...
          <Text mt="15px" variant="referDesc">
            Lootmogul.com brings you the best incentive that friendship can
            offer. Bond over your love for Online Sports Trivia along with your
            friends. Earn cash, Refer your Friends NOW.
          </Text>
          <Box
            pl={["15px", "25px"]}
            pr={["15px", "25px"]}
          ...
          >
            ...
            >
              <Text
                ...
                color="white"
              >
                {user ? user.referral_code?.code : "Log in for referal code"}
              </Text>
              <Button
                borderRadius="30px"
                onClick={() => {
