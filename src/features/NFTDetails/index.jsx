        ...
        <Box mt={6}>
            ...
            >
                ...
                <img
                    src={
                        isOpen
                            ? "/assets/nfts/arrow_up.svg"
                            : "/assets/nfts/arrow_down.svg"
                    }
                    alt="Arrow"
                />
            </Flex>
...
const NFTDetails = ({ nftData }) => {
    ...
    return (
        <Box my={6} mx={"4%"}>
            ...
            >
                ...
                {isMobileDevice && (
                    <Popover>
                        ...
                        <NextShare
                            link={process.env.NEXT_BASE_URL+"/nfts/" + nftData?.slug}
                            caption={
            ...
            <Grid
                templateColumns={isMobileDevice ? "1fr" : "repeat(2, 1fr)"}
                gap={6}
            >
                <GridItem>
                ...
                <GridItem>
                    ...
                    <Flex
                        ...
                        pb={3}
                        borderBottom={
                            isMobileDevice ? "none" : "1px solid #1C1C1C"
                        }
                    >
                        <Box>
                            <HStack spacing={6}>
            ...
            <Box mb={12} mt={6}>
                ...
                <Box>
                    <ScrollMenu apiRef={ref}>
                        {data?.related_nfts?.data?.map((item, index) => (
                            <NftCard
                                itemId={`nft-${index}`}
                                key={`nft-${index}`}
                                nft={item}
