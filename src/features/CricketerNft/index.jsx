import { Box, Flex, Text, Input, Button, Link ,    FormControl,
 ...
 strapi.create("subscriptions",subscription).then((resp)=>{
    ...
    return (
        <>
         ...
         {msg?<Text color="white" fontFamily="Sora" mt="3%" fontSize={["14px", "16px", "16px", "20px"]}>{msg}</Text>:           <Formik
            initialValues={{
                email: "",
                        ...
                        <Box mt="1%" m="auto" textAlign={"center"}>
                           ...
                           {({ field, form }) => (
                               ...
                               >
                                ...
                                <Input mt="5%" id="email"  {...field} bgColor={"white"} borderRadius={"1px"} width="100%" textAlign="center"  type="email" placeholder="Enter your email Id" textColor={"black"} />
                                <FormErrorMessage color="primary_1">
                                    {form.errors.email}
                                </FormErrorMessage></FormControl> )}</Field>
                                <Button mt="5%!important"  type="submit" borderRadius={"1px"} margin="auto" width="50%">Submit</Button>
