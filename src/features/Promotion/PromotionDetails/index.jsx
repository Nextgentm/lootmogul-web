        ...
        >
            ...
            {detailedData && (
                <HeadingBanner
                    ...
                    promotion={detailedData || []}
                />
            )}
            {detailedData?.details && (
                <Instructions data={detailedData?.details} />
            )}
            {detailedData?.terms && (
                <TermsCondition terms={detailedData?.terms} />
            )}
        </Box>
    );
};
        ...
        promotion && (
            <Box mt={["16px", "40px"]}>
                <Box display={["flex", "none"]}>
                    <PromoCard isDetailed={true} promotion={promotion} />
                </Box>
                <Flex
                    w="100%"
                    rounded="lg"
...
const Instructions = ({ data }) => {
    return (
        <Box textAlign={"left"} mt={["25px", "30px"]}>
            <ReactMarkdown
