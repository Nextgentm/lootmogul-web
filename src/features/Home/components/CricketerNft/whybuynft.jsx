...
const WhyBuyNft = () => {
    ...
    const cricketNftImages = [
        { img: "Mayank.gif", name: "Mayank Dagar", spec: "All-Rounder", path: "https://lootmogul.com/games/mayank-dagar-cricket" },
        { img: "Kartik.gif", name: "Kartik Tyagi", spec: "Right Arm Fast Bowler", path: "https://lootmogul.com/games/kartik-tyagi-cricket" },
        { img: "Mayank.gif", name: "Mayank Dagar", spec: "All-Rounder", path: "https://lootmogul.com/games/mayank-dagar-cricket" },
        { img: "Kartik.gif", name: "Kartik Tyagi", spec: "Right Arm Fast Bowler", path: "https://lootmogul.com/games/kartik-tyagi-cricket" },
        { img: "Mayank.gif", name: "Mayank Dagar", spec: "All-Rounder", path: "https://lootmogul.com/games/mayank-dagar-cricket" },
        { img: "Kartik.gif", name: "Kartik Tyagi", spec: "Right Arm Fast Bowler", path: "https://lootmogul.com/games/kartik-tyagi-cricket" }
        ...
        <>
            ...
            <SimpleGrid columns={[1, 2, 2, 2]} ml="10px" gridRowGap={5} gridColumnGap={5} mt="30px" mb="30px" w="100%">
                ...
                {cricketNftImages.map((item, index) => {
                    ...
                    return <Box mt={["5%", "2%"]} textAlign="center" >
                        <Image ml={["", "", "5%", "20%"]} alignItems={"center"} background={"#1c1c1c"} src={`/assets/cricketnfts/${item.img}`} width={["", "380px"]} height={["", "380px"]} />
                        ...
                        <Button fontSize={["20px", "", "20px", "30px"]} fontFamily="Blanch" color={"black"} borderRadius={["20px"]} margin="auto" mt="2%" width={["130px"]} height={["30px"]} variant="outline" bgColor={"white"} onClick={() => window.open(item.path
                        )} > Explore Now</Button>
                    </Box>
