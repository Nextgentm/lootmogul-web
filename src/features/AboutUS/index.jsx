    ...
    return (
        <>
            ...
            >
                ...
                >
                    {data?.length > 0 &&
                        data[0].about_us_profiles.data.map((item, index) => {
                            return (
                                <Link
                                    target="_blank"
                                    key={"nerd" + index}
                                ...
                                >
                                    ...
                                    >
                                        <Avatar
                                            background={"#1c1c1c"}
                                            borderRadius={0}
                                            src={item.profilePic?.data.url}
                                            boxSize={["60px", "120px"]}
                                        />
                                        <Text color="#FFC533" mt={["5%", "3%"]}>
                                            {item.tagLine}
                                        </Text>
                                        <Text mt={["5%", "3%"]}>
                                            {item.name}
                ...
                >
                    {data?.length > 1 &&
                        data[1].about_us_profiles.data.map((item, index) => {
                            return (
                                <Link
                                    _focus={{
                                        border: "none",
                ...
                >
                    {data?.length > 2 &&
                        data[2].about_us_profiles.data.map((item, index) => {
                            return (
                                <Link
                                    ...
                                    >
                                        ...
                                        >
                                            <Image
                                                ...
                                                src={item.logo?.data?.url}
                                                objectFit="cover"
                                            />
                                        </Box>
                                    </Box>
                                    <UnOrderedLMLists
                                        listItems={item.Intro?.map(
                                            (data) => data.item
                                        )}
                                    />
                                </Link>
                ...
                >
                    {data?.length > 3 &&
                        data[3].about_us_profiles.data.map((item, index) => {
                            return (
                                <Link
                                    target="_blank"
                                    key={"investor" + index}
