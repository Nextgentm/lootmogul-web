import {
    Text, Button, Flex, Box,
    Spacer, HStack, Popover, PopoverTrigger, Link
...
const NftCard = ({ nft, isMobileDevice, showInfo = false }) => {
    ...
    return (
        <Box cursor="pointer" m="auto" textAlign="center" w={[showInfo ? "300px" : "200px", showInfo ? "300px" : "200px", showInfo ? "300px" : "200px", "300px"]} h={[showInfo ? "520px" : "200px", showInfo ? "520px" : "200px", showInfo ? "520px" : "200px", showInfo ? "520px" : "420px"]}
