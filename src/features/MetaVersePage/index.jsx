    ...
    return (
        <Box width={"100%"}>
            ...
            >
                ...
                <Flex textAlign={'center'} width={'50%'} border={'1px solid white'} justifyContent='Center' color='white'>
                    <Box flex='1'>
                        <Text><b>Fan seats (Limited availability)</b></Text>
                        <ol style={{ listStyleType: "none" }}>
                            <li>
                                <Text> 1.Your avatar becomes part of the global game</Text>
                            </li>
                            <li>
                                <Text> 2.VIP access to the live events in the stadium </Text>
                            </li>
                            <li>
                                <Text> 3.Exclusive access to real-world events and merchandise</Text>
                            </li>
                        </ol>
                    </Box>
                    <Box flex='1' style={{ borderLeft: '2px solid white' }}>
                        <Text><b>Brand space (Limited availability)</b></Text>
                        <ol style={{ listStyleType: "none" }}>
                            <li>
                                <Text> 1.Your brand gets global reach of millions of sports fans</Text>
                            </li>
                            <li>
                                <Text> 2.Organize your live events inside the metaverse </Text>
                            </li>
                            <li>
                                <Text> 3.Lease your brand space NFTs during premier events </Text>
                            </li>
                        </ol>
                    </Box>
                </Flex>
