import { Box, Text, Heading, Avatar, AvatarGroup, Image, Center } from "@chakra-ui/react";
...
const QuestionOption = ({
  ...
  const [rate, setRate] = useState(1);
    ...
    useEffect (()=>{
        if(voiceOver && question && options && options.length>0)
      callVoiceOver();
    },[options]);
    useEffect (()=>{
        if(!voiceOver)
                            ...
                            <>
                                ...
                                >
                                    <AvatarGroup
                                        ...
                                        right="-4px"
                                    >
                                        {allUserOptions?.length && allUserOptions[index].map(
                                            (user) =>
                                                user.is_active && (
                                                    <Avatar
                                                        name={user.username}
