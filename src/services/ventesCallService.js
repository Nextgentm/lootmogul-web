...
const ventesCallService = async () => {
    ...
    if (utm_medium == "va" && process.env.NEXT_PUBLIC_SENTRY_ENV === 'staging') {
...
export { ventesCallService };


const ventesGamePlayService = async (user) => {
