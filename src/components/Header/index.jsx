        ...
        <>
            {!isHideHeader && (
                ...
                >
                  ...
                  {!user && ( router.route != "/gamecampaign" && router.route !="/cricket" &&  router.route !="/dsg-durban-cricket-stadium" && router.route !=  "/thanksgiving-campaign" && router.route != "/signupcampaign")  && (
                            <>
                                <Button
                                    {...loginBtnStyle}
