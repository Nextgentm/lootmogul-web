  ...
  return (
    <Box>
        ...
        >
            ...
            >
                <Text pr={["0px", "0px", "20px", "20px"]} variant="footerText" w="100%" fontWeight="400" fontSize="18px" textAlign="left">
        ...
        >
            <Flex
                ...
                justify={["center", "center", "flex-start", "flex-start"]}
            >
                <Text pt={["20px", "20px", "0px", "0px"]} pr={["0px", "0px", "20px", "20px"]} variant="footerText" w="100%" fontWeight="400" fontSize="18px" textAlign="left">
