            ...
            <Grid templateColumns={['repeat(1, 1fr)', 'repeat(1, 1fr)', 'repeat(2, 1fr)']} gap={2}>
                ...
                <GridItem>
                    <Link
                        _focus={{ border: "none", boxShadow: "none" }}
                        _hover={{ textDecoration: "none" }}
                        href="https://opensea.io/assets?search%5Bquery%5D=lootmogul"
                        isExternal
                        mt={['0px','0px','30px']}
                        mb="20px"
                        display="flex"
